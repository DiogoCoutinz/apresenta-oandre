...
// Steps: 0=title, 1=erasmus+janeiro, 2=projeto1, 3=pictuz, 4=quote
    ...
    <div className="relative z-10 flex flex-col h-full p-14">
      ...
      >
        <div className="flex-1">
          <p className="gradient-text text-xs font-bold tracking-[0.3em] uppercase mb-4">Erasmus → Janeiro 2025</p>
          <h2 className="text-white font-black mb-5" style={{ fontSize: 'clamp(24px, 3vw, 40px)', letterSpacing: '-0.02em', lineHeight: 1.1 }}>
            "Este é o meu ano."
          </h2>
          <p className="text-white/55 font-light leading-relaxed mb-5" style={{ fontSize: 'clamp(14px, 1.4vw, 18px)' }}>
            Em Barcelona, um professor obcecado com IA disse uma frase que ficou gravada. Quando voltei, decidi que 2025 seria o meu ano.
          </p>
          ...
          >
            <p className="text-white font-bold italic" style={{ fontSize: 'clamp(16px, 1.8vw, 24px)' }}>
              "Se vocês querem realmente aproveitar algo, aproveitem esta revolução."
            </p>
          </div>

          <p className="text-white/40 font-light mb-6" style={{ fontSize: 'clamp(13px, 1.2vw, 16px)' }}>
            Lock-in total. +8h por dia, sem rendimento, sem garantias. 10 meses assim.
          </p>
      ...
      {/* Step 2: PRIMEIRO PROJETO — Agente IA */}
      <div
        className={`flex-1 flex items-center gap-8 ${T}`}
        style={{
          opacity: step === 2 ? 1 : 0,
      ...
      {/* Step 4: MINDSET — mentor photos */}
      <div
        className={`flex-1 flex flex-col items-center justify-center text-center ${T}`}
        style={{
          opacity: step === 4 ? 1 : 0,
          transform: step === 4 ? 'translateY(0) scale(1)' : 'translateY(40px) scale(0.9)',
      ...
      >
        <p className="gradient-text text-xs font-bold tracking-[0.3em] uppercase mb-10">Mindset, A Maior Vantagem</p>

        {/* Quotes side by side */}
        <div className="flex items-stretch gap-8 mb-10 w-full max-w-4xl">
          {/* Left quote */}
          <div
            className="flex-1 flex flex-col items-center justify-center text-center px-8 py-10 rounded-2xl"
            style={{
              background: 'linear-gradient(135deg, rgba(26,111,255,0.06), rgba(26,111,255,0.02))',
              border: '1px solid rgba(26,111,255,0.15)',
            }}
          >
            <p
              className="text-white font-black italic leading-tight mb-4"
              style={{
            ...
            <div className="flex items-center gap-2 mt-auto">
              <div className="w-10 h-10 rounded-full overflow-hidden" style={{ border: '2px solid rgba(26,111,255,0.4)' }}>
                <img src="/hormozi.png" alt="Alex Hormozi" className="w-full h-full object-cover" />
              </div>
              <p className="text-white/40 text-xs font-medium">Alex Hormozi</p>
            </div>
          </div>

          {/* Divider */}
          <div className="w-px self-stretch" style={{ background: 'linear-gradient(to bottom, transparent, rgba(123,47,255,0.3), transparent)' }} />
          ...
          >
            ...
            >
              "Trabalha tanto que a sorte deixe de ser desculpa."
            </p>
            <div className="flex items-center gap-2 mt-auto">
              <div className="w-10 h-10 rounded-full overflow-hidden" style={{ border: '2px solid rgba(192,38,211,0.4)' }}>
                <img src="/publio.png" alt="Públio Silva" className="w-full h-full object-cover" />
              </div>
              <p className="text-white/40 text-xs font-medium">Públio Silva</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          <div className="w-10 h-10 rounded-full overflow-hidden" style={{ border: '2px solid rgba(123,47,255,0.3)' }}>
            <img src="/mike.png" alt="Miguel Milhão" className="w-full h-full object-cover" />
          </div>
          <p className="text-white/40 text-xs font-medium">Miguel Milhão</p>
          <p className="text-white/25 text-xs ml-2">Ouvi-los e mudou tudo.</p>
        </div>
      </div>
    </div>
  </div>
