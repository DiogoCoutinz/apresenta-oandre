...
const channels = [
  {
    ...
    Icon: MessageSquare,
    name: 'Cold DM',
    tagline: 'Ser direto sem pedir licença',
  ...
  },
  {
    ...
    desc: 'Entrar em negócios locais, eventos e perguntar diretamente se precisam de serviços digitais.',
    rgb: '75,63,255',
    tag: 'Field Sales',
    winner: false,
  },
  {
    ...
    desc: 'Posts, vídeos e reels que atraem leads qualificadas sem custo por clique.',
    rgb: '123,47,255',
    tag: 'Inbound',
    winner: false,
  },
